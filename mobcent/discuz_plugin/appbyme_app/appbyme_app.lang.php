...
$scriptlang[APPBYME_DZ_PLUGIN_ID] = array(
    ...
    'mobcent_portal_module_param_other_filter' => '其他条件选择,好友(当前用户好友发的主题),关注(当前用户收听的用户发的主题),收藏(当前用户收藏的版块下的主题)',
    'mobcent_portal_module_param_topic_picrequired' => '必须含图片附件',
    'mobcent_portal_module_param_topic_orderby' => '主题排序方式,按最后回复时间倒序排序,按发布时间倒序排序,按回复数倒序排序,按浏览次数倒序排序,按热度倒序排序,按主题评价倒序排序,按距离近到远排序(只包括客户端主题)',
    ...
    'mobcent_open_tips' => '
        <li>URL请以http://或者https://开头</li>
        <li>帖子详情页中的帖子ID请用{tid}代替</li>
    ',
    'mobcent_open_name' => '开放管理',
    'mobcent_open_aboutus_open' => '关于我们',
    'mobcent_open_aboutus_tips' => '设置之后点击关于，会出现对应的页面',
    'mobcent_open_foundpw_open' => '找回密码',
    'mobcent_open_foundpw_tips' => '设置手机客户端找回密码网址，该值不为空时,客户端将采用此url来找回密码,如果想用本来的找回密码,请设为空',
    'mobcent_open_userinfo_open' => '个人设置',
    'mobcent_open_userinfo_tips' => '在个人中心点击头像会调转到指定的页面，而不是安米默认的个人设置',
    'mobcent_open_thread_0_name' => '普通主题帖',
    'mobcent_open_thread_0_tips' => '设置之后普通主题帖都会跳到这个页面上',
    'mobcent_open_thread_1_name' => '投票主题帖',
    'mobcent_open_thread_1_tips' => '设置之后投票主题帖都会跳到这个页面上',
    'mobcent_open_thread_2_name' => '商品主题帖',
    'mobcent_open_thread_2_tips' => '设置之后商品主题帖都会跳到这个页面上',
    'mobcent_open_thread_3_name' => '悬赏主题帖',
    'mobcent_open_thread_3_tips' => '设置之后悬赏主题帖都会跳到这个页面上',
    'mobcent_open_thread_4_name' => '活动主题帖',
    'mobcent_open_thread_4_tips' => '设置之后活动主题帖都会跳到这个页面上',
    'mobcent_open_thread_5_name' => '辩论主题帖',
    'mobcent_open_thread_5_tips' => '设置之后辩论主题帖都会跳到这个页面上',
    'mobcent_open_thread_127_name' => '插件相关主题帖',
    'mobcent_open_thread_127_tips' => '设置之后插件相关主题帖都会跳到这个页面上',
);
