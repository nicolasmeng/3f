...
if(!empty($pluginarray)){
  $plugin = C::t('common_plugin')->fetch_by_identifier('appbyme_app');
  C::t('common_plugin')->update($plugin['pluginid'],array('name'=>$pluginarray['plugin']['name'],'copyright'=>$pluginarray['plugin']['copyright']));
}
