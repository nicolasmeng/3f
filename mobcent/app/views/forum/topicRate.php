...
<body>
    ...
    <form method="post" action="<?php echo $formUrl; ?>">
        <h4 class="rate_font"><?php echo WebUtils::lp('forum_topicRate_title'); ?></h4>
        <div id="rata_interval">
            <table style="margin:0 auto;text-align:center;width:100%" >
                <tr class="rate_top">
                    <td colspan="2"></td>
                    <td width=25%><?php echo WebUtils::lp('forum_topicRate_grade_area'); ?></td>
                    <td width=25%><?php echo WebUtils::lp('forum_topicRate_now_surplus'); ?></td>
                </tr>
        ...
        <div id="rate_category">
            ...
            <?php endforeach; ?>
                <option value="0"><?php echo WebUtils::lp('forum_topicRate_reason_custom'); ?></option>
            </select>
            <p><textarea id="reason" name="reason" class="pt" rows="2"></textarea></p>
            <p class="o pns">
                <label for="sendreasonpm">
                    <input type="checkbox" name="sendreasonpm" id="sendreasonpm" class="pc" style="margin-right:5px;"><?php echo WebUtils::lp('forum_topicRate_notification_author'); ?>
                </label>
            </p>
            <p style="text-align:center">
                <button type="submit" name="modsubmit" id="modsubmit" class="btu" value="<?php echo WebUtils::lp('forum_topicRate_ok'); ?>" ><span><?php echo WebUtils::lp('forum_topicRate_ok'); ?></span>
                </button>
            </p>
        </div>
    </form>
