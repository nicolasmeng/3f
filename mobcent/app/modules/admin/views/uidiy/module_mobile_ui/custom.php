...
<div class="custom" >
    ...
    <div class="custom-style">
        ...
        <?php foreach ($customStyle['componentList'] as $component): ?>
            ...
            <?php elseif ($component['style'] == AppbymeUIDiyModel::COMPONENT_STYLE_LAYOUT_ONE_COL_MID): ?>
            <!-- 单栏样式中 -->
            <div class="custom-style-layout-one-col-mid">
                <?php foreach ($component['componentList'] as $comp): ?>
                <?php if ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_IMAGE): ?>
            ...
            <!-- 单栏样式低 -->
            <div class="custom-style-layout-one_col-low">
                <?php foreach ($component['componentList'] as $comp): ?>
                <?php if ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_IMAGE): ?>
                    <img src="<?php echo $comp['icon'] ?>" style="width:320px;height:70px;" class="img-rounded uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>">
                <?php elseif ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_TEXT_IMAGE): ?>
                    <img src="<?php echo $comp['icon'] ?>" class="img-rounded textImage uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>">
                    <p class="textImage-title text-left"><?php echo WebUtils::subString($comp['desc'], 0, 15, 'UTF-8'); ?></p>
                <?php elseif ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_TEXT_OVERLAP_DOWN): ?>
            ...
            <?php elseif ($component['style'] == AppbymeUIDiyModel::COMPONENT_STYLE_LAYOUT_ONE_COL_SUPER_LOW): ?>
            <!-- 单栏样式超低 -->
            <div class="custom-style-layout-one_col-super-low">
                <?php foreach ($component['componentList'] as $comp): ?>
                <?php if ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_IMAGE): ?>
                    <img src="<?php echo $comp['icon'] ?>" style="width:320px;height:36px;" class="img-rounded uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>">
                <?php elseif ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_TEXT_IMAGE): ?>
                    <img src="<?php echo $comp['icon'] ?>" class="img-rounded textImage uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>">
                    <p class="textImage-title text-left"><?php echo WebUtils::subString($comp['desc'], 0, 15, 'UTF-8'); ?></p>
                <?php elseif ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_TEXT_OVERLAP_DOWN): ?>
            ...
            <div class="layouttwocol-high">
                ...
                <div class="layouttwocol-hight-img">
                    <img src="<?php echo $comp['icon'] ?>" class="img-rounded uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>" >
                </div>
                <?php elseif ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_TEXT_IMAGE): ?>
                <div class="layouttwocol-hight-img">
                    <img src="<?php echo $comp['icon'] ?>" class="img-rounded uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>" >
            ...
            <?php elseif ($component['style'] == AppbymeUIDiyModel::COMPONENT_STYLE_LAYOUT_TWO_COL_SUPER_LOW): ?>
            <!-- 双栏样式超低 -->
            ...
            <?php elseif ($component['style'] == AppbymeUIDiyModel::COMPONENT_STYLE_LAYOUT_THREE_COL_SUPER_LOW): ?>
            <!-- 三栏样式低 -->
            <div class="layout-three-col-super-low">
                <?php foreach ($component['componentList'] as $comp): ?>
                <?php if ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_IMAGE): ?>
                    <div class="custom-style-layout-three-col-super-low">
                        <img src="<?php echo $comp['icon'] ?>" class="img-rounded uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>" style="width:100px;">
                    </div>
                <?php elseif ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_TEXT_IMAGE): ?>
                    <div class="custom-style-layout-three-col-super-low">
                        <img src="<?php echo $comp['icon'] ?>" class="img-rounded uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>" style="width:100px;">
            ...
            <?php elseif ($component['style'] == AppbymeUIDiyModel::COMPONENT_STYLE_LAYOUT_FOUR_COL_SUPER_LOW): ?>
            <!-- 四栏样式 -->
            <div class="layout-four-col-super-low">
                <?php foreach ($component['componentList'] as $comp): ?>
                <?php if ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_IMAGE): ?>
                    <div class="custom-style-layout-four-col-super-low">
                        <img src="<?php echo $comp['icon'] ?>" class="img-rounded uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>" style="width:75px;height:40px;">
                    </div>
                <?php elseif ($comp['iconStyle'] == AppbymeUIDiyModel::COMPONENT_ICON_STYLE_TEXT_IMAGE): ?>
                    <div class="custom-style-layout-four-col-super-low">
                        <img src="<?php echo $comp['icon'] ?>" class="img-rounded uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>" style="width:75px;height:40px;">
            ...
            <?php elseif ($component['style'] == AppbymeUIDiyModel::COMPONENT_STYLE_LAYOUT_SLIDER_HIGH): ?>
            <!-- 幻灯片 -->
            <div class="carousel slide carousel-example-generic_one" data-ride="carousel" data-interval="3000" style="width:337px;height:168px;">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item <?php echo ($key == 0) ? 'active' : '' ?>">
                            <img src="<?php echo $comp['icon']; ?>" alt="" style="width:337px;height:168px;" class="uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>">
            ...
            <?php elseif ($component['style'] == AppbymeUIDiyModel::COMPONENT_STYLE_LAYOUT_SLIDER_MID): ?>
            <!-- 幻灯片 -->
            <div class="carousel slide carousel-example-generic_one" data-ride="carousel" data-interval="3000" style="width:337px;height:126px;">
                    ...
                    <div class="carousel-inner">
                        <?php foreach ($component['componentList'] as $key => $comp): ?>
                        <div class="item <?php echo ($key == 0) ? 'active' : '' ?>">
                            <img src="<?php echo $comp['icon']; ?>" alt="" style="width:337px;height:126px;" class="uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>">
                            <div class="carousel-caption">
                                <p><?php echo WebUtils::subString($comp['desc'], 0, 10, 'UTF-8'); ?></p> 
                            </div>
                        </div>
            ...
            <?php elseif ($component['style'] == AppbymeUIDiyModel::COMPONENT_STYLE_LAYOUT_SLIDER_LOW): ?>
            <!-- 幻灯片 -->
            <div class="carousel slide carousel-example-generic_one" data-ride="carousel" data-interval="3000" style="width:337px;height:83px;">
                    ...
                    <div class="carousel-inner">
                        <?php foreach ($component['componentList'] as $key => $comp): ?>
                        <div class="item <?php echo ($key == 0) ? 'active' : '' ?>">
                            <img src="<?php echo $comp['icon']; ?>" alt="" style="width:337px;height:83px;" class="uidiy-mobileui-component" data-component-data="<?php echo rawurlencode(WebUtils::jsonEncode($comp, 'utf-8')); ?>">
                            <div class="carousel-caption">
                                <p><?php echo WebUtils::subString($comp['desc'], 0, 10, 'UTF-8'); ?></p> 
                            </div>
                        </div>
