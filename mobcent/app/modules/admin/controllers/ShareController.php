...
class ShareController extends AdminController {
    ...
    public function actionList($id, $page = '1', $pageSize = '20') {
        ...
        $listmap = array('type' => array('1' => 'QQ', '2' => 'QQ空间', '3' => '微信好友', '4' => '朋友圈', '5' => '新浪微博', '6' => 'FaceBook'), 'form' => array('portal' => '文章', 'topic' => '帖子', 'app' => 'App分享'));
    ...
    public function actionAdd($id = '') {
        ...
        if (!empty($_POST)) {
            ...
            if (empty($_POST['get'])) {
                ShareUtils::endWebApi($res, WebUtils::t('分享规则中三个必须需要选择一个'), MOBCENT_ERROR_DEFAULT);
            }
            if ($_POST['get']['topic']) {
