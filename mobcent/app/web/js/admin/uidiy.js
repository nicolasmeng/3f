...
$(function () {
    ...
    var getAjaxApiUrl = function (route) {
        var uidiyid = document.getElementById('uidiyid').value;
        return uidiyGlobalObj.rootUrl + '/index.php?r=' + route + '&apphash=' + uidiyGlobalObj.apphash + '&id=' + uidiyid;
    };
    ...
    var submitComponentHelper = function (form) {
        var componentType = $(form['componentType[]']),
            ...
            componentTitle = $(form['componentTitle[]']),
                ...
                topicComplexForumId = $(form['topicComplexForumId[]']),
        ...
        for (var i = 0; i < componentType.length; i++) {
            ...
            var type = componentType[i].value,
                    filter = '',
                    orderby = '',
                    forumId = parseInt(type == COMPONENT_TYPE_TOPICLIST ? topicForumId[i].value : (type == COMPONENT_TYPE_TOPICLIST_COMPLEX ? topicComplexForumId[i].value : topicSimpleForumId[i].value)),
                    subListStyle = '',
                    subDetailViewStyle = '',
                    dataId = 0;
            ...
            switch (type) {
                ...
                case COMPONENT_TYPE_USERLIST:
                    ...
                    break;
                case COMPONENT_TYPE_TALK:
                    subListStyle = forumTopiclistStyleTalk[i].value;
                    break;
                default:
                    break;
            }
            ...
            var extParams = {
                ...
                talkId:parseInt(topicTalkId[i].value) || 0,
                filter: filter,
                orderby: orderby,
                ...
                listBoardNameState: parseInt(listBoardNameState[i].value)
            };
            var model = {
                px: Number(componentPx[i].value),
        ...
        var returnComponentList = [];
        componentList = jsonSort(componentList, 'px', false);

        for (var i = 0; i < componentType.length; i++) {
            var model = new ComponentModel(componentList[i]);
            returnComponentList.push(model);
        }
        return returnComponentList;
    };
    ...
    var ComponentView = Backbone.View.extend({
        ...
        initUIConfig: function () {
            this.uiconfig = {
                ...
                isShow_typeTopiclisttalk: 1,
                isShow_typeTalklist:1,
                isShow_typeTopiclistComplex:1,
                isShow_typeWebapp: 1,
                ...
                isShow_typeScan: 1,
                isShow_typeLivelist: 1,
                isShow_typeClassificationlist: 0,
                ...
                isShow_typeSearch: 0,
                isShow_typeConfigSwitch: 1,
                isShow_typeFasttalk:0,
                isShow_typeContacts:0,
                iconRatio: '适当',
        ...
        changeStyleUIByType: function (type, isInitSelect) {
            ...
            switch (type) {
                ...
                case COMPONENT_TYPE_TOPICLIST:
                case COMPONENT_TYPE_TOPICLIST_SIMPLE:
                case COMPONENT_TYPE_TOPICLIST_COMPLEX:
                case COMPONENT_TYPE_TALKPOSTLIST:
                case COMPONENT_TYPE_POSTLIST:
                    ...
                    $styleSelectDiv.find('[value=' + COMPONENT_STYLE_BOARD_SPLIT + ']').hide();
                    $styleSelectDiv.find('[value=' + COMPONENT_STYLE_CIRCLE + ']').hide();

                    if (type == COMPONENT_TYPE_FORUMLIST) {
                        $styleSelectDiv.find('[value=' + COMPONENT_STYLE_BOARD_SPLIT + ']').show();
                    }
                    if (type == COMPONENT_TYPE_NEWSLIST) {
                        ...
                        $styleSelectDiv.find('[value=' + COMPONENT_STYLE_CIRCLE + ']').show();
                    }
                    if (type == COMPONENT_TYPE_TOPICLIST || type == COMPONENT_TYPE_TOPICLIST_SIMPLE || type == COMPONENT_TYPE_TOPICLIST_COMPLEX  || type == COMPONENT_TYPE_TALKPOSTLIST) {
                        $styleSelectDiv.find('[value=' + COMPONENT_STYLE_IMAGE_SUDOKU + ']').show();
                        $styleSelectDiv.find('[value=' + COMPONENT_STYLE_TIEBA + ']').show();
                        // $styleSelectDiv.find('[value='+COMPONENT_STYLE_HEADLINES+']').show();
                        $styleSelectDiv.find('[value=' + COMPONENT_STYLE_NETEASE_NEWS + ']').show();
        ...
        toggleExtConfigDiv: function (type) {
            ...
            this.$el.find('.list-ext-config-div-new').hide();
            ...
            if(type == COMPONENT_TYPE_NEWSLIST || type == COMPONENT_TYPE_TOPICLIST || type == COMPONENT_TYPE_TOPICLIST_SIMPLE || type == COMPONENT_TYPE_FORUMLIST || type == COMPONENT_TYPE_TOPICLIST_COMPLEX || type == COMPONENT_TYPE_TALK || type == COMPONENT_TYPE_TALKPOSTLIST){
            	this.$el.find('.list-ext-config-div-new').show();
            }
        },
        uploadIcon: function () {
    ...
    var createComponentViewSliderHigh = function (model) {
        return new ComponentView({model: model, uiconfig: {
            isShow_px: 1,
            isShow_icon: 1,
            isShow_desc: 1,
            isShow_delete: 1,
            iconRatio: '1:2(640x320)',
        }});
    };
    var createComponentViewSliderMid = function (model) {
        return new ComponentView({model: model, uiconfig: {
            isShow_px: 1,
            isShow_icon: 1,
            isShow_desc: 1,
            isShow_delete: 1,
            iconRatio: '3:8(640x240)',
        }});
    };
    var createComponentViewSliderLow = function (model) {
        return new ComponentView({model: model, uiconfig: {
            isShow_px: 1,
            isShow_icon: 1,
            isShow_desc: 1,
            isShow_delete: 1,
            iconRatio: '1:4(640x160)',
        }});
    };
    ...
    var createComponentViewTopbar = function (model) {
        return new ComponentView({model: model, uiconfig: {
                ...
                isShow_typeScan: 1,
                isShow_typeLivelist: 0,
                isShow_typeConfigSwitch: 0,
                isShow_typeClassificationlist: 0,
                isShow_typeTopiclistComplex:0,
                isShow_typeTopiclisttalk:0,
                isShow_typeTalklist:0,
                isShow_typeFasttalk:1,
                isShow_typeContacts:1,
            }});
    };
    ...
    var CustomStyleComponentEditDlg = Backbone.View.extend({
        ...
        initUIConfig: function () {
            this.uiconfig = {
                ...
                isShow_layoutSliderHigh: 0,
                isShow_layoutSliderMid: 0,
                isShow_layoutSliderLow: 0,
                isShow_layoutNewsAuto: 0,
                isShow_layoutSubnavFlat:0,
                isShow_layoutSeparator:0,
            };
        },
        events: {
           ...
           // on:function('.add-stylelist-btn','addStylelist'){}
        },
        render: function () {
            this.initUIConfig();
            // 过滤可选的组件布局
            ...
            switch (style) {
                case COMPONENT_TYPE_TRANSPARENT:
                    this.uiconfig.isShow_layoutSubnavFlat=1;
                    break;
                case COMPONENT_STYLE_LAYOUT_DEFAULT:
                    this.uiconfig.isShow_layoutSeparator=1;
                case COMPONENT_STYLE_LAYOUT_LINE:
                    ...
                    this.uiconfig.isShow_layoutSubnavFlat = 0;
                    break;
                case COMPONENT_STYLE_LAYOUT_IMAGE:
                    this.uiconfig.isShow_layoutOneColHigh = 1;
                    this.uiconfig.isShow_layoutOneColMid = 1;
                    this.uiconfig.isShow_layoutOneColLow = 1;
                    this.uiconfig.isShow_layoutOneColSuperLow = 1;
                    ...
                    this.uiconfig.isShow_layoutSliderHigh=1;
                    this.uiconfig.isShow_layoutSliderMid=1;
                    this.uiconfig.isShow_layoutSliderLow=1;
                    break;
                default:
                    break;
            }
        ...
        addComponentItem: function () {
            ...
            switch (layoutStyle) {
                case COMPONENT_STYLE_LAYOUT_SLIDER_HIGH:
                    var view = createComponentViewSliderHigh(new ComponentModel());
                    $('.component-view-container').append(view.render().el);
                    break;
                case COMPONENT_STYLE_LAYOUT_SLIDER_MID:
                    var view = createComponentViewSliderMid(new ComponentModel());
                    $('.component-view-container').append(view.render().el);
                    break;
                case COMPONENT_STYLE_LAYOUT_SLIDER_LOW:
                    var view = createComponentViewSliderLow(new ComponentModel());
                    $('.component-view-container').append(view.render().el);
                    break;
                default:
                    break;
        ...
        onChangeComponentStyle: function () {
            ...
            if (layoutStyle == this.model.attributes.style) {
                ...
                switch (layoutStyle) {
                    ...
                    case COMPONENT_STYLE_LAYOUT_ONE_COL_SUPER_LOW:
                    case COMPONENT_STYLE_LAYOUT_NEWS_AUTO:
                    case COMPONENT_TYPE_SEPARATOR:
                        size = 1;
                        break;
                    ...
                    case COMPONENT_STYLE_LAYOUT_TWO_COL_SUPER_LOW:
                    ...
                    case COMPONENT_STYLE_LAYOUT_THREE_COL_SUPER_LOW:
            ...
            if (layoutStyle == COMPONENT_STYLE_LAYOUT_SLIDER_HIGH ||
                    layoutStyle == COMPONENT_STYLE_LAYOUT_SLIDER_MID||
                    layoutStyle == COMPONENT_STYLE_LAYOUT_SLIDER_LOW) {
            ...
            for (var i = 0; i < componentList.length; i++) {
                ...
                switch (layoutStyle) {
                    ...
                    case COMPONENT_STYLE_LAYOUT_ONE_COL_LOW:
                        ...
                        uiconfig.isShow_iconStyleTextOverlapDownVideo = 1;
                        var iconRatioMap = {};
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_DEFAULT] = '640x120';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_IMAGE] = '640x120';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_LINE] = '640x120';
                    ...
                    case COMPONENT_STYLE_LAYOUT_ONE_COL_SUPER_LOW:
                        ...
                        uiconfig.isShow_iconStyleTextOverlapDownVideo = 1;
                        var iconRatioMap = {};
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_DEFAULT] = '640x70';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_IMAGE] = '640x70';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_LINE] = '640x70';
                        uiconfig.iconRatio = iconRatioMap[style];
                        break;
                    case COMPONENT_STYLE_LAYOUT_TWO_COL_HIGH:
                        uiconfig.isShow_iconStyleImage = 1;
                        ...
                        var iconRatioMap = {};
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_DEFAULT] = '286*286';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_IMAGE] = '286*286';
                    ...
                    case COMPONENT_STYLE_LAYOUT_TWO_COL_MID:
                        ...
                        var iconRatioMap = {};
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_DEFAULT] = '286*240';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_IMAGE] = '286*240';
                    ...
                    case COMPONENT_STYLE_LAYOUT_TWO_COL_LOW:
                        ...
                        var iconRatioMap = {};
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_DEFAULT] = '286*130';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_IMAGE] = '286*130';
                     ...
                     case COMPONENT_STYLE_LAYOUT_TWO_COL_SUPER_LOW:
                        ...
                        var iconRatioMap = {};
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_DEFAULT] = '286*68';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_IMAGE] = '300*80';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_LINE] = '320*100';
                        uiconfig.iconRatio = iconRatioMap[style];
                        break;
                    case COMPONENT_STYLE_LAYOUT_THREE_COL_HIGH:
                        uiconfig.isShow_iconStyleImage = 1;
                    ...
                    case COMPONENT_STYLE_LAYOUT_THREE_COL_SUPER_LOW:
                        ...
                        var iconRatioMap = {};
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_DEFAULT] = '184*68';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_IMAGE] = '184*80';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_LINE] = '214*100';
                        uiconfig.iconRatio = iconRatioMap[style];
                        break;
                    case COMPONENT_STYLE_LAYOUT_FOUR_COL:
                        uiconfig.isShow_iconStyleImage = 1;
                    ...
                    case COMPONENT_STYLE_LAYOUT_FOUR_COL_SUPER_LOW:
                        ...
                        var iconRatioMap = {};
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_DEFAULT] = '130*68';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_IMAGE] = '130*68';
                        iconRatioMap[COMPONENT_STYLE_LAYOUT_LINE] = '130*68';
                        uiconfig.iconRatio = iconRatioMap[style];
                        break;
                    case COMPONENT_STYLE_LAYOUT_ONE_COL_ONE_ROW:
                    case COMPONENT_STYLE_LAYOUT_ONE_ROW_ONE_COL:
                    ...
                    case COMPONENT_STYLE_LAYOUT_THREE_COL_TEXT:
                        ...
                        break;
                    case COMPONENT_STYLE_LAYOUT_SLIDER_HIGH:
                        uiconfig.isShow_px= 1;
                        uiconfig.isShow_delete = 1;
                        uiconfig.isShow_iconStyle = 0;
                        uiconfig.iconRatio = '1:2(320x640)';
                        break;
                    case COMPONENT_STYLE_LAYOUT_SLIDER_MID:
                        uiconfig.isShow_px= 1;
                        uiconfig.isShow_delete = 1;
                        uiconfig.isShow_iconStyle = 0;
                        uiconfig.iconRatio = '3:8(240x640)';
                        break;
                    case COMPONENT_STYLE_LAYOUT_SLIDER_LOW:
                        uiconfig.isShow_px= 1;
                        uiconfig.isShow_delete = 1;
                        uiconfig.isShow_iconStyle = 0;
                        uiconfig.iconRatio = '1:4(160x640)';
                        break;
                    case COMPONENT_STYLE_LAYOUT_NEWS_AUTO:
                        ...
                        break;
                    case COMPONENT_TYPE_SUBNAVFLAT:
                        uiconfig.isShow_px = 0;
                        uiconfig.isShow_desc = 0;
                        uiconfig.isShow_icon = 0;
                        uiconfig.isShow_icon = 0;
                        uiconfig.isShow_iconStyle = 0;

                        uiconfig.isShow_typeForumlist = 0;
                        uiconfig.isShow_typeNewslist = 1;
                        uiconfig.isShow_typeTopiclistComplex = 0;
                        uiconfig.isShow_typeTopiclistSimple = 1;
                        uiconfig.isShow_typeTopiclisttalk = 0;
                        uiconfig.isShow_typeTalklist = 0;
                        uiconfig.isShow_typePostlist = 0;
                        uiconfig.isShow_typeNewsview = 0;
                        uiconfig.isShow_typeModuleRef = 0;
                        uiconfig.isShow_typeWebapp = 0;
                        uiconfig.isShow_typeUserinfo = 0;
                        uiconfig.isShow_typeUserlist = 0;
                        uiconfig.isShow_typeMessagelist = 0;
                        uiconfig.isShow_typeSetting = 0;
                        uiconfig.isShow_typeAbout = 0;
                        uiconfig.isShow_typeWeather = 0;
                        uiconfig.isShow_typeSearch = 0;
                        uiconfig.isShow_typeFasttext = 0;
                        uiconfig.isShow_typeFastimage = 0;
                        uiconfig.isShow_typeFastcamera = 0;
                        uiconfig.isShow_typeFastaudio = 0;
                        uiconfig.isShow_typeSign = 0;
                        uiconfig.isShow_typeScan = 0;
                        uiconfig.isShow_typeFasttalk = 0;
                        uiconfig.isShow_typeContacts = 0;
                        uiconfig.isShow_typeSubnavFlat = 0;
                        uiconfig.isShow_typeLivelist = 0;
                        uiconfig.isShow_typeClassificationlist = 0;
                        uiconfig.isShow_typeConfigSwitch = 0;
                        break;
                    case COMPONENT_TYPE_SEPARATOR:
                        uiconfig.isShow_title = 0;
                        uiconfig.isShow_px = 0;
                        ...
                        uiconfig.isShow_typeForumlist = 0;
                        uiconfig.isShow_typeNewslist = 0;
                        uiconfig.isShow_typeTopiclistComplex = 0;
                        uiconfig.isShow_typeTopiclistSimple = 0;
                        uiconfig.isShow_typeTopiclisttalk = 0;
                        uiconfig.isShow_typeTalklist = 0;
                        uiconfig.isShow_typePostlist = 0;
                        uiconfig.isShow_typeNewsview = 0;
    ...
    var ModuleEditDlg = Backbone.View.extend({
        ...
        events: {
        	'change #versionNum' : 'onChangeVersionNum',
        ...
        onChangeVersionNum: function(){
        	var versionNum = $('#versionNum').val();
        	var oldVersion = typeof(this.model.attributes.versionNum) == 'undefined' ? '1.0' : this.model.attributes.versionNum;
        	if(versionNum < oldVersion){
        		$('#versionNum').val(oldVersion);
        		alert('高版本不能向低版本切换');
        		return false;
        	}else{
        		this.model.attributes.versionNum = versionNum;
        		moduleEditDlg.model = this.model;
                moduleEditDlg.render();
                this.model.attributes.versionNum = oldVersion;
        	}
        },
        onChangeModuleType: function (event) {
            ...
            switch (moduleType) {
                ...
                case MODULE_TYPE_SUBNAV:
                    ...
                    if (moduleModel.attributes.componentList.length > 0) {
                        componentList = this.model.attributes.componentList;
                    }
                    for (var i = 0; i < size - moduleModel.attributes.componentList.length; i++) {
                        componentList.push(new ComponentModel());
                    }
                    for (var i = 0; i < componentList.length; i++) {
                        var model = componentList[i];
                ...
                case MODULE_TYPE_NEWCUSTOM:
                case MODULE_TYPE_CUSTOM:
                    var componentList = [];
                    if (this.model.attributes.type == moduleType) {
                        componentList = this.model.attributes.componentList;
                    }else if(moduleType == MODULE_TYPE_NEWCUSTOM){
                        ...
                        componentList.push(model);
                        var model = new ComponentModel({'type':'layout','style':'layoutTransparent'});
                        model.attributes.extParams.styleHeader = {
                            isShow: 1,
                            title: '',
                            position: 0,
                        ...
                        model.set({'componentList': [
                            new ComponentModel({'type':'layout','style':'layoutSubnavFlat'})
                        ]});
                        //console.log(model);
                        var length = model.attributes.componentList[0].attributes.componentList.length;
                        if(length < 4){
                            var tmpmodel = _.clone(model.attributes.componentList[0].attributes.componentList);//.get('componentList');
                            var addModel = new ComponentModel();
                            for (var i = parseInt(length); i < 4; i++) {
                                tmpmodel.push(addModel);
                            }
                            model.attributes.componentList[0].set({'componentList':tmpmodel});
                        }
                        componentList.push(model);
                    }
                    moduleModel.tempComponentList = new ComponentList();
                    if (moduleType == MODULE_TYPE_CUSTOM || moduleType == MODULE_TYPE_NEWCUSTOM) {
        ...
        moduleSubmit: function (event) {
            ...
            //对于话题加入发表话题的topbar
            if(moduleType == MODULE_TYPE_FULL && this.model.attributes.componentList[0].attributes.type == COMPONENT_TYPE_TALK){
                var havetalk = false;
                var countbar = 0;
                 var counti = 0;
                for (var i = 0;i < this.model.attributes.rightTopbars.length;i++){
                    if(this.model.attributes.rightTopbars[i].attributes.type == 'empty'){
                        countbar++;
                    }
                    counti++;
                }
                ...
                if(havetalk){
                    var newcomponentModel = new ComponentModel({type: COMPONENT_TYPE_FASTTALK,icon:COMPONENT_ICON_TOPBAR+'27'});
                    this.model.attributes.rightTopbars[0] = newcomponentModel;
                }
            }
            var error = this.model.validate(this.model.attributes);
            if (error != '') {
        ...
        addFastpostItem: function () {
            ...
            var icon = '';
            switch (type) {
                case COMPONENT_TYPE_FASTTEXT:
                    icon = COMPONENT_ICON_FASTPOST + 27;
                    break;
                case COMPONENT_TYPE_FASTIMAGE:
                    icon = COMPONENT_ICON_FASTPOST + 28;
                    break;
                case COMPONENT_TYPE_FASTCAMERA:
                    icon = COMPONENT_ICON_FASTPOST + 29;
                    break;
                case COMPONENT_TYPE_FASTAUDIO:
                    icon = COMPONENT_ICON_FASTPOST + 45;
                    break;
                case COMPONENT_TYPE_SIGN:
                    icon = COMPONENT_ICON_FASTPOST + 30;
                    break;
                default:
                    icon = '';
                    break;
    ...
    var ModuleTopbarDlg = Backbone.View.extend({
        ...
        submitTopbar: function () {
            ...
            switch (type) {
                case COMPONENT_TYPE_FASTTEXT:
                    icon = COMPONENT_ICON_TOPBAR + 21;
                    break;
                case COMPONENT_TYPE_FASTIMAGE:
                    icon = COMPONENT_ICON_TOPBAR + 22;
                    break;
                case COMPONENT_TYPE_FASTCAMERA:
                    icon = COMPONENT_ICON_TOPBAR + 24;
                    break;
                case COMPONENT_TYPE_FASTAUDIO:
                    icon = COMPONENT_ICON_TOPBAR + 23;
                    break;
                case COMPONENT_TYPE_USERINFO:
                    icon = COMPONENT_ICON_TOPBAR + 6;
                    break;
                case COMPONENT_TYPE_SEARCH:
                    icon = COMPONENT_ICON_TOPBAR + 10;
                    break;
                case COMPONENT_TYPE_SCAN:
                    icon = COMPONENT_ICON_TOPBAR + 25;
                    break;
                case COMPONENT_TYPE_FASTTALK:
                    icon = COMPONENT_ICON_TOPBAR + '27';
                    break;
                case COMPONENT_TYPE_CONTACTS:
                    icon = COMPONENT_ICON_TOPBAR + '26';
                    break;
                default:
                    icon = '';
                    break;
    ...
    var MainView = Backbone.View.extend({
        ...
        events: {
            ...
            'change #allVersionNum' : 'onChangVersionNum'
        },
        initialize: function () {
        ...
        saveUIDiy: function (isSync, success, error) {
            ...
            Backbone.ajax({
                url: getAjaxApiUrl('admin/uidiy/saveuidiy'),
                type: 'post',
                dataType: 'json',
                data: {
                    id: uidiyid,
                ...
                Backbone.ajax({
                    ...
                    success: function (result, status, xhr) {
                        ...
                        if (uidiyid == '0') {
                            ...
                            location.href = uidiyGlobalObj.rootUrl + '/index.php?r=admin/uidiy&id=' + uidiyid;
                        }
                    }
                });
            }
        ...
        onChangVersionNum : function(){
        	var version = $('#allVersionNum').val();
        	window.location.href=getAjaxApiUrl('admin/uidiy/index')+'&version='+version;
        }
    });
