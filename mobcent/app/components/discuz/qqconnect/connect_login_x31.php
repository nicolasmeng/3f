...
/**
 * copy from discuz DISCUZ_ROOT/source/plugin/qqconnect/connect/connect_login.php, and do some modification
 * 
...
if (MobcentDiscuz::isF10()) {
    $callback = $_G['setting']['connect']['callback_domain'] ? "http://" . rtrim(str_replace("http://", "", $_G['setting']['connect']['callback_domain']), "/") . "/" : $_G['siteurl'];
    $QQLoginBaseUrl = $callback . '/mobcent/app/web/index.php?r=user/qqlogin';
} else {
