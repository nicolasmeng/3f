...
return array(
    ...
    'mobcent_forum_m' => WebUtils::t('月份值存在冲突'),
    ...
    'mobcent_post_newthread_success' => WebUtils::t('00000000:发表成功'),
    'mobcent_post_reply_succeed' => WebUtils::t('00000000:回复成功'),
    'post_thread_closed' => WebUtils::t('00500000:抱歉，本主题已关闭，不再接受新内容'),
    'forum_passwd' => WebUtils::t('00500001:本版块需要密码'),
    'post_newbie_span' => WebUtils::t('00500002:抱歉，您在注册时间起 {newbiespan} 分钟后才能拥有发表权限'),
    'post_hide_nopermission' => WebUtils::t('00500003:抱歉，您没有权限使用 [hide] 代码'),
    'postperm_qqonly_nopermission' => WebUtils::t('00500004:为避免您的帐号被盗用，请您绑定QQ帐号后发表，绑定后请使用QQ帐号登录'),
    'postperm_login_nopermission' => WebUtils::t('00500005:抱歉，您尚未登录，没有权限在该版块发表'),
    'postperm_login_nopermission_mobile' => WebUtils::t('00500006:您尚未登录，没有权限在该版块发表'),
    'postperm_none_nopermission' => WebUtils::t('00500007:抱歉，您没有权限在该版块发表'),
    'post_forum_newthread_nopermission' => WebUtils::t('00500008:抱歉，本版块只有特定用户组可以发新主题'),
    'replyperm_login_nopermission' => WebUtils::t('00500009:抱歉，您尚未登录，没有权限在该版块回复'),
    'replyperm_none_nopermission' => WebUtils::t('00500010:抱歉，您没有权限在该版块回复'),
    'post_nonexistence' => WebUtils::t('00500010:帖子不存在'),
    'post_flood_ctrl' => WebUtils::t('00500011:抱歉，您两次发表间隔少于 {floodctrl} 秒，请稍候再发表'),
    'post_flood_ctrl_posts_per_hour' => WebUtils::t('00500012:抱歉，您所在的用户组每小时限制发回复 {posts_per_hour} 个，请稍候再发表'),
    ...
    'post_dp_null' => WebUtils::t('00500017:抱歉，您尚未输入点评内容'),
    'post_subject_isnull' => WebUtils::t('00500017:抱歉，您尚未输入标题'),
    'post_message_isnull' => WebUtils::t('00500017:抱歉，您尚未输入内容'),
    'period_nopermission' => WebUtils::t('00500031:抱歉，管理员设置了每日 {banperiods} 不能进行此操作，请其他时间再试'),
    ...
    'replyperm_upgrade_nopermission' => WebUtils::t('00500028:抱歉，您需要升级所在的用户组后才能回复'),
    'postperm_upgrade_nopermission' => WebUtils::t('00500029:抱歉，您需要升级所在的用户组后才能发表'),
    'post_not_my_thread' => WebUtils::t('00500030:您没有权限操作他人的帖子！'),
    'post_edit_timelimit' => WebUtils::t('00500031:抱歉，您的帖子从发表到现在已超过 {edittimelimit} 分钟，不能再进行此操作'),
    'post_edit_thread_ban_del' => WebUtils::t('00500032:您暂时无权限进行该操作！'),
    'post_edit_reward_already_reply' => WebUtils::t('00500033:无法删除已经有回复的悬赏帖！'),
    'post_edit_thread_already_reply' => WebUtils::t('00500034:无法删除已经有回复的主题！'),
    'post_edit_debate_del' => WebUtils::t('00500035:暂时无法删除辩论贴'),
    'mobcent_must_bind_thread' => WebUtils::t('00500036:需要绑定手机之后才可以发帖哦'),
    'mobcent_must_bind_post' => WebUtils::t('00500036:需要绑定手机之后可以回帖哦'),
    //帖子 errCode 006XXXXX
    ...
    'search_portal_closed' => WebUtils::t('01100007:抱歉，门户搜索已关闭'),
    ...
    'follow_followed_ta' => WebUtils::t('02000022:您已经关注了TA'),
    'follow_add_succeed' => WebUtils::t('02000023:成功关注'),
    ...
    'no_privilege_editsign' => WebUtils::t('020000042:您暂无权限编辑签名'),
    'too_long_sign' => WebUtils::t('020000043:签名不得超过{number}字符！'),
    'profile_censor_sign' => WebUtils::t('02000044:当前含有敏感字符'),
    ...
    'noreply_yourself_error' => WebUtils::t('07000006:您不能对自己的回复进行投票'),
    'noreply_voted_error' => WebUtils::t('07000007:您已经对此回复投过票了'),
    ...
    //快速注册
    'fastregister_failed' => WebUtils::t('11000001:快速注册失败！'),
    //积分 1200XXXX
    'mobcent_credits_policy_lowerlimit' => WebUtils::t('12000001:抱歉，{ruletext} {rulecredit}，本操作后您的{title}将不足 {lowerlimit} {unit}'),
    'mobcent_credits_policy_lowerlimit_fid' => WebUtils::t('12000002:抱歉，本版块{ruletext} {rulecredit}，本操作后您的{title}将不足 {lowerlimit} {unit}'),
	'mobcent_credits_policy_lowerlimit_fid_3f7s' => WebUtils::t('12000002:抱歉，参赛需要先众筹20元，您的{title}不足，请及时充值'),
    'mobcent_credits_policy_lowerlimit_norule' => WebUtils::t('12000002:抱歉，本操作后您的{title}将不足 {lowerlimit} {unit}'),

    //分享 1300XXXX
    'mobcent_share_success'=>WebUtils::t('0000000:分享成功,您本次分享获得{str}'),
    'mobcent_share_form_nofound'=>WebUtils::t('13000001:当前Form不存在'),
    'mobcent_share_activity_nofound'=>WebUtils::t('13000002:活动不存在'),
    'mobcent_share_activity_nosatrt'=>WebUtils::t('13000003:活动未开始'),
    'mobcent_share_activity_isend'=>WebUtils::t('13000004:活动已结束'),
    'mobcent_share_mode_addmax'=>WebUtils::t('13000005:{str}最多只能获得{num}次.'),
    'mobcent_share_type_haveget'=>WebUtils::t('13000006:当前分享平台不支持加积分'),
    'mobcent_share_form_isnotopen'=>WebUtils::t('13000007:当前分享类型不可加加分'),
    'mobcent_share_forum_noin'=>WebUtils::t('13000008:当前版块不在范围内'),
    'mobcent_share_topic_noin'=>WebUtils::t('13000009:当前帖子不在范围内'),
    'mobcent_share_portal_noin'=>WebUtils::t('13000010:当前文章不在范围内'),
    'mobcent_share_discuz_credit'=>WebUtils::t('APP分享'),
    'mobcent_share_today'=>WebUtils::t('今日'),
    'mobcent_share_thisact'=>WebUtils::t('当次活动'),
    'mobcent_vote_start' => WebUtils::t('发起投票'),
    'mobcent_topic_publish' => WebUtils::t('发表帖子'),
    'mobcent_personage_integral' => WebUtils::t('积分'),
);
