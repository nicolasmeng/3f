...
class PhotoListAction extends CAction {
    ...
    private function _getImageInfoList($res, $landUid, $uid, $page, $pageSize, $albumId) {
        ...
        foreach ($imageList as $image) {
            ...
            if(stripos($tempimageInfo['filepath'],'http:') !== false){
                $imageInfo['thumb_pic'] = $tempimageInfo['filepath'].'-'.Yii::app()->params['qiniu']['app_qiniu_thumb'];
                $imageInfo['origin_pic'] = $tempimageInfo['filepath'];
            }else{
